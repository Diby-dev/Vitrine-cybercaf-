      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {partners.map((p, idx) => {
            const Icon = p.icon;
            return (
              <ScrollReveal key={idx} variant="zoom-in" delay={idx * 0.15}>
                <div className="p-5 rounded-xl bg-slate-50 border border-slate-200 flex items-center gap-4 hover:border-sky-300 hover:bg-white hover:shadow-md transition-all h-full">
